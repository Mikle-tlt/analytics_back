...
public class TotalGrowthService {
    ...
    public Map<String, Object> growth(Long productId, String date_with, String date_by)
        ...
        for (int i = 0; i < revenues.length; i++) {
            ...
            double income1 = product.getRevenue(date1, date2) + product.getRevenueOffline(date1, date2);

            date1.setTime(with.getTime());
            date2.setTime(with.getTime() + ONE_DAY * 4);

            double income2 = product.getRevenue(date1, date2) + product.getRevenueOffline(date1, date2);
